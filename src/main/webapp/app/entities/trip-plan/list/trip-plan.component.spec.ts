...
import { sampleWithRequiredData } from '../trip-plan.test-samples';
import { TripPlanService } from '../service/trip-plan.service';

import { TripPlanComponent } from './trip-plan.component';
import SpyInstance = jest.SpyInstance;

describe('TripPlan Management Component', () => {
  let comp: TripPlanComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TripPlanComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.tripPlans()[0]).toEqual(expect.objectContaining({ id: 11048 }));
  });

  describe('trackId', () => {
    it('should forward to tripPlanService', () => {
      const entity = { id: 11048 };
      jest.spyOn(service, 'getTripPlanIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTripPlanIdentifier).toHaveBeenCalledWith(entity);
