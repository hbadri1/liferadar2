...
export const sampleWithRequiredData: ITripPlan = {
  ...
  endDate: dayjs('2026-02-18T18:00'),
};
...
export const sampleWithPartialData: ITripPlan = {
  ...
  title: 'shrilly gosh',
  description: 'pro',
  startDate: dayjs('2026-02-18T10:00'),
  endDate: dayjs('2026-02-18T19:00'),
};
...
export const sampleWithFullData: ITripPlan = {
  ...
  endDate: dayjs('2026-02-17T16:00'),
};

export const sampleWithNewData: NewTripPlan = {
  title: 'consequently owlishly',
  startDate: dayjs('2026-02-17T07:00'),
  endDate: dayjs('2026-02-17T15:00'),
  id: null,
};
