...
@Component({
  selector: 'jhi-life-radar',
  templateUrl: './life-radar.component.html',
  styleUrl: './life-radar.component.scss',
  imports: [SharedModule, RouterModule],
})
export default class LifeRadarComponent implements OnInit, OnDestroy {
