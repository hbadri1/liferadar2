...
import LifeRadarComponent from './life-radar.component';

describe('Home Component', () => {
  let comp: LifeRadarComponent;
  let fixture: ComponentFixture<LifeRadarComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(LifeRadarComponent);
