...
/**
 * Criteria class for the {@link com.atharsense.lr.domain.Pillar} entity. This class is used
 * in {@link com.atharsense.lr.web.rest.PillarResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /pillars?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class PillarCriteria implements Serializable, Criteria {
    ...
    public PillarCriteria() {}

    public PillarCriteria(PillarCriteria other) {
    ...
    @Override
    public PillarCriteria copy() {
        return new PillarCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final PillarCriteria that = (PillarCriteria) o;
        return (
