...
/**
 * Criteria class for the {@link com.atharsense.lr.domain.SubLifePillar} entity. This class is used
 * in {@link com.atharsense.lr.web.rest.SubLifePillarResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /sub-life-pillars?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SubLifePillarCriteria implements Serializable, Criteria {
    ...
    public SubLifePillarCriteria(SubLifePillarCriteria other) {
    ...
    @Override
    public SubLifePillarCriteria copy() {
        return new SubLifePillarCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SubLifePillarCriteria that = (SubLifePillarCriteria) o;
        return (
