...
/**
 * Criteria class for the {@link com.atharsense.lr.domain.TripPlan} entity. This class is used
 * in {@link com.atharsense.lr.web.rest.TripPlanResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /trip-plans?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
...
public class TripPlanCriteria implements Serializable, Criteria {
    ...
    public TripPlanCriteria() {}

    public TripPlanCriteria(TripPlanCriteria other) {
    ...
    @Override
    public TripPlanCriteria copy() {
        return new TripPlanCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TripPlanCriteria that = (TripPlanCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, title, description, startDate, endDate, ownerId, distinct);
    }
